...
blitter(ref.agnus.agnusBlitter),
ciaa(ref.ciaA),
ciab(ref.ciaB),
controlPort1(ref.controlPort1),
controlPort2(ref.controlPort2),
copper(ref.agnus.agnusCopper),
cpu(ref.cpu),
denise(ref.denise),
diagBoard(ref.diagBoard),
diskController(ref.paula.paulaDiskController),
dmaDebugger(ref.agnus.agnusDmaDebugger),
df0(ref.df0),
df1(ref.df1),
df2(ref.df2),
df3(ref.df3),
