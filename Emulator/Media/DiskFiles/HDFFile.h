...
public:
    ...
    bool isCompatiblePath(const std::filesystem::path &_path) const override { return isCompatible(_path); }
...
public:
    ...
    HDFFile(const std::filesystem::path &_path) throws { init(_path); }
